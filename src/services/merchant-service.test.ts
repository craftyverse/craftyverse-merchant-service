...
describe("Merchant Service", () => {
  ...
  describe("createMerchant", () => {
    it("should create a new merchant", async () => {
      const mockMerchant = await testUtils.createMockMerchant("Supplier");

      const savedMerchant: MerchantDocument | string =
        await MerchantService.createMerchant({
          merchantType: "Supplier",
          merchantUserId: mockMerchant.merchantUserId,
          merchantName: mockMerchant.merchantName,
          merchantDescription: mockMerchant.merchantDescription,
          merchantCountry: mockMerchant.merchantCountry,
          merchantState: mockMerchant.merchantState,
          merchantAddressLine1: mockMerchant.merchantAddressLine1,
          merchantAddressLine2: mockMerchant.merchantAddressLine2,
          merchantPostCode: mockMerchant.merchantPostCode,
          merchantOwnerFirstName: mockMerchant.merchantOwnerFirstName,
          merchantOwnerLastName: mockMerchant.merchantOwnerLastName,
          merchantOwnerEmail: mockMerchant.merchantOwnerEmail,
          merchantOwnerPhone: mockMerchant.merchantOwnerPhone,
          merchantOwnerLicenseDocumentUrl:
          ...
          merchantStoreIndustry: mockMerchant.merchantStoreIndustry,
          merchantStoreCurrency: mockMerchant.merchantStoreCurrency,
          merchantStoreTimeZone: mockMerchant.merchantStoreTimeZone,
        });
